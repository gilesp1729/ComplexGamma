...
#define AUX_MOUSEWHEEL  128
#define AUX_MOUSECLICK  256
...
/*
** ToolKit Event Status Messages (must agree with TK)
*/
...
#endif
GLenum APIENTRY auxInitWindowA(LPCSTR, BOOL, HMENU, BOOL);
GLenum APIENTRY auxInitWindowW(LPCWSTR, BOOL, HMENU, BOOL);
